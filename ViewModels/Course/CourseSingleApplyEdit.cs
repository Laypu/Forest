...
{
    public class CourseSingleApplyEdit
    {
        public CourseSingleApplyEdit()
        {
        ...
        public List<bool> SISingalUse { get; set; }
        public List<bool> SISingalMust { get; set; }
        public Dictionary<string, List<string>> SITableItem { get; set; }
